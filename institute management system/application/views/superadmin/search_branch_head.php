	...
	<table id="user_data" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        foreach ($data as $dt): ?>
            <tr>
                ...
                <!-- <td><?php echo $dt['master_admin_image']; ?></td>  -->
                
                <td><img src="<?php echo base_url('uploads/branch_head/'.$dt['master_admin_image']); ?>" height=40 width=50 ></td>
                ...
                <!-- <a href="<?php echo base_url("super_admin/update_branch/");?>" class="btn btn-primary update" >Edit</a> -->
 				...
 				<a href="<?php echo base_url('super_admin/update_branch_head/'.$dt['master_admin_id']); ?>" class="glyphicon glyphicon-edit"></a>
 			</td>
 			<td>
                                <a href="<?php echo base_url('super_admin/delete_branch_head/'.$dt['master_admin_id']); ?>" class="glyphicon glyphicon-trash" onclick="return confirm('Are you sure to delete?')"></a>
