<?php $this->load->view('faculty/header'); ?>
    <!-- Page Content -->
    <div class="container">
...
<!-- Modal -->
		<div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="<?php echo base_url('faculty/addevent'); ?>">			
		...
		<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			<form class="form-horizontal" method="POST" action="<?php echo base_url('faculty/editevent'); ?>">
			  <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script src="<?php echo base_url('js/jquery.js');?>"></script>
	...
	$(document).ready(function() {
		...
		function edit(event){
			...
			$.ajax({
			 url: "<?php echo base_url('faculty/editevent'); ?>",
			 type: "POST",
			 data: {Event:Event},
