...
<?php } ?>
 ...
 <button type="button" class="btn btn-warning btn-md ins" data-toggle="modal" data-target="#addtest">ADD TEST</button>
	<div>
		<br>
	</div>
...
<!-- 
							...
							<select class="form-control" name="number_of_que" id="number_of_que" required="required">
