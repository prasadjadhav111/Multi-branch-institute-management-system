...
<div id="single-wrapper">
	...
	<form action="<?php echo base_url('login/check_email');?>"  method="post" class="frm-single">
		<div class="inside">
...
<?php endif; ?>
			...
			<div class="frm-input"><input type="email" name="email" placeholder="Enter Email" class="frm-inp" required><i class="fa fa-envelope frm-ico"  ></i>
 <div class="help-block with-errors"></div>
			</div>

			<!-- /.frm-input -->
			<button type="submit" class="frm-submit btn">Send Email<i class="fa fa-arrow-circle-right"></i></button>
			<a href="<?php echo base_url('login');?>" class="a-link"><i class="fa fa-sign-in"></i>Already have account? Login.</a>
		</form>
